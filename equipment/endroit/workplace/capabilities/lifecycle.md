...
- `accept-this` records the accepting authority, scope and exact revision
  without changing Material lifecycle or completion;
...
These effects are distinct. Never infer acceptance from retention, delivery
